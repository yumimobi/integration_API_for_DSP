...
- [SAMPLE OF JSON'S REQUEST AND RESPONSE](#sample-of-jsons-request-and-response)
	- [banner](#banner)
		...
		- [deeplink response of banner, other types are similar to this.](#deeplink-response-of-banner-other-types-are-similar-to-this)
	- [interstitial](#interstitial)
		- [request of interstitial](#request-of-interstitial)
		- [response of interstitial](#response-of-interstitial)
		- [response of interstitial video](#response-of-interstitial-video)
	- [native](#native)
...
### response of interstitial video
...
### adm response of rewarded video
